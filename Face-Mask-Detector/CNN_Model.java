...
import ai.certifai.solution.classification.CustomModel;
...
public class CNN_Model {
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(CNN_Model.class);

    private static int epochs = 40; //120
...
//                ,new Pair<>(showImage,1.0) //uncomment this to show transform image
        ...
        MaskDetectorDataIterator.setup(batchSize, 80, transform);

        //create iterators
        DataSetIterator trainIter = MaskDetectorDataIterator.trainIterator();
        DataSetIterator testIter = MaskDetectorDataIterator.testIterator();
